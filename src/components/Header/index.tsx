    ...
    return (
        ...
        <div className='basis-1/5 flex items-center gap-6 justify-end w-full'>
            <div className="hidden md:flex justify-end items-center w-64">
                <div className="relative">
                    ...
                    <button type="submit" className="absolute right-0 top-0 mr-3 pt-2">
                        <FontAwesomeIcon icon={faMagnifyingGlass} className="text-lg text-Navy" />
                    </button>
                </div>
            </div>
            ...
            <div className='bg-white rounded-full w-7 h-7 flex items-center justify-center cursor-pointer relative'>
                <FontAwesomeIcon icon={faBell} className="text-lg lg:text-2xl" style={{color: '#424874'}}/>
                <div className='absolute -top-2 md:-top-3 -right-2 w-5 h-5 flex items-center justify-center bg-Yellow text-Navy font-semibold rounded-full text-xs'>1</div>
            </div>
            {/* DROPDOWN */}
