        ...
        <div className="bg-Navy h-screen p-4">
            <div className="flex flex-col gap-6">
                ...
                <div id="createProject">
                    <h1 className="text-white text-xl font-semibold uppercase tracking-wider text-left">Or Starting Now</h1>
                    <div className="flex mx-auto items-center justify-center mt-4">
                        <div className="relative inline-flex group w-full justify-center">
                            ...
                            <Link href={'/projects/create/'} className="relative flex gap-2 w-full items-center justify-center px-4 py-2 text-sm bg-black opacity-20 text-gray-300 hover:text-gray-100 hover:opacity-70 transition-all duration-200 rounded-lg ease-linear">
                                <span>Create</span>
                ...
                {/* MOST VIEWED */}
                <div id="mostViewed">
                    <h1 className="text-white text-xl font-semibold uppercase tracking-wider text-left">Most Viewed</h1>
                    <div className="flex flex-col mt-4 gap-4">
                        { mostViewedData.map((_) => (
                            <div className="flex items-center justify-between">
                                <div className="flex items-center">
                                    <img src="/assets/avatar.png" alt='avatar' className="rounded-full w-10 h-10" />
                                    <div className="ml-4">
                ...
                {/* MOST SEARCHED */}
                <div id="mostSearched">
                    <h1 className="text-white text-xl font-semibold uppercase tracking-wider text-left">Most Searched</h1>
                    <div className="flex flex-wrap mt-4 gap-2">
                        { mostSearchedData.map((_) => (
                            <div className="group relative inline-flex">
                                ...
                                <Link href={'#'} className="relative flex gap-2 w-full items-center justify-center px-2 py-1 text-xs bg-black opacity-20 text-gray-300 hover:text-gray-100 hover:opacity-70 transition-all duration-200 rounded-full ease-linear">
                                    <span>Tech</span>
                                    <FontAwesomeIcon icon={faPlus} />
                                </Link>
                            </div>
